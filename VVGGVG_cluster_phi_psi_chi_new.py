...
for cluster_loop in range(4,5):
    ...
    for val_loop in range(0,3):
        ...
        print(np.amin(square_chi1[~ind0]))
        ...
        ax = fig.add_subplot(111)
        ax.set_aspect('equal', adjustable='box')
        plt.imshow(square_chi1/Val_60_phi.shape[0]/100,origin='lower', cmap='jet')#, interpolation='nearest')
        plt.colorbar()
        plt.xlabel('$\phi$',fontsize=20)
        plt.ylabel('$\psi$',fontsize=20)
        plt.title('$\chi_1$ = 60$^{\circ}$',fontsize=20)
        ...
        ax = fig.add_subplot(111)
        ax.set_aspect('equal', adjustable='box')
        plt.imshow(square_chi1/Val_180_phi.shape[0]/100,origin='lower', cmap='jet')#, interpolation='nearest')
        plt.colorbar()
        plt.xlabel('$\phi$',fontsize=20)
        plt.ylabel('$\psi$',fontsize=20)
        plt.title('$\chi_1$ = 180$^{\circ}$',fontsize=20)
        ...
        ax = fig.add_subplot(111)
        ax.set_aspect('equal', adjustable='box')
        plt.imshow(square_chi1/Val_300_phi.shape[0]/100, origin='lower',cmap='jet')#, interpolation='nearest')
        plt.colorbar()
        plt.xlabel('$\phi$',fontsize=20)
        plt.ylabel('$\psi$',fontsize=20)
        plt.title('$\chi_1$ = 300$^{\circ}$',fontsize=20)
